...
with open("template_behavior_{richard_kabiru}.txt", "a") as f:
    ...
    def no_of_players():
        ...
        while plyrs_no_initial <= players_no:
            ...
            name = print("Player",plyrs_no_initial, "is",player_name, file= f)
    ...
    def comp_move(): 
        ...
        for i in comp_score:
            if roll() == 6:
                ...
                print("The computer score is:", comp_score, file= f)
                print("next player")
                comp_total += i
                print("The computer total is",comp_total, file= f)
                break
    ...
    def current_game_status():
        ...
        print("Human score: "+str(hum_total), "\nComputer score: " +str(comp_total), file= f)
        if comp_total > hum_total:
            point_diff = comp_total - hum_total
            print("You are ", point_diff, "ahead of human", file= f)
        
        elif comp_total < hum_total:
            point_diff = hum_total - comp_total
            print("You are ", point_diff, "ahead of computer", file= f)

        else:
            print("Its a tie", point_diff, file= f)
    ...
    def show_final_result(comp_total, hum_total):
        ...
        if comp_total > 50 and hum_total <= 50:
            print("Computer has won", file= f)

        elif hum_total > 50 and comp_total <= 50:

            print("Human has won", file= f)
    ...
    def main():
        #with open("template_behavior_{dice}.txt", "a") as f:
            ...
            while run:
                ...
                run = False
                print("Final Score", show_final_result(), file = f)
