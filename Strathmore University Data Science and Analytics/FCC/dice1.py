...
def human_move():
    ...
    return hum_total #hum_score, 

# Checking the current game status
def current_game_status():#hum_total, comp_total
    '''
...
while run:
    ...
    print("This is the computer score",computer_move)

    # Calling human move function
    hum_move = human_move()
    print("This is the human score",hum_move)
